...
3. Unzip files and setup permission with following commands:
    ```bash
    unzip eIQ-GenAI-Flow2.0-Container-on-NXP-i.mx95-main.zip
    chmod +x -R eIQ-GenAI-Flow2.0-Container-on-NXP-i.mx95-main
    cd eIQ-GenAI-Flow2.0-Container-on-NXP-i.mx95-main
    ```
